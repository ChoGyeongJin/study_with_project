...
<head>
    ...
    <title>메인페이지</title>
    <!-- 경로 지정 시 디렉토리 레벨: webapp와 views의 레벨이 같음 -->
        ...
        <section id="container-content">
            ...
            <section id="main-image">
                ...
                <div id="image-menu">
                    ...
                    <span><a href="#"><img src="resources/css/img/image-menu02.png" alt="프라이빗 임대 숙소">프라이빗 임대숙소</a></span>
                    ...
                    <span><a href="#"><img src="resources/css/img/image-menu06.png" alt="공항 이동 교통편 서비스">공항이동 교통서비스</a></span>
                </div>
